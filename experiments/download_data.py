...
def _parse_config(*args, **kwargs):
    ...
    parser.add_argument('-e', '--helen', dest='helen', action='store_const',
        const='getHELEN',
        help="Print the instructions to download the ibug annotated HELEN dataset") 
    parser.add_argument('-i', '--ibug', dest='ibug', action='store_const',
        const='get300W',
        help="Print the instructions to download the 300W dataset and organise folder structure") 
    ...
    parser.add_argument('-p', '--menpo', dest='menpo', action='store_const',
        const='getMenpo',
        help="Print the instructions to download the menpo dataset") 
...
def get300W():
    ...
    print("=" * 60)
    print("Due to licensing constraints you will need to download the 300W annotated "\
