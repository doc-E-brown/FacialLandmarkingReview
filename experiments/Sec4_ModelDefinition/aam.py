...
class AAM(object):
    ...
    def __init__(self, path_to_data, model_type=HolisticAAM,
                 basename='aam', verbose=True):
        """ """
    ...
    # batch size 128
    def train_model(self, diagonal=None, batch_size=256,
    ...
    def fit_model(self):
        """ Fit model using the a noisy shape
        constructed from the bounding box"""
    ...
    def predict_test_set(self):
        ...
        for idx, i in enumerate(self.test_set):
            ...
            initial_shape = noisy_shape_from_bounding_box(
                gt_s, gt_s.bounding_box())

            # Predict the result
            fit_result = self.model_fit.fit_from_shape(
                i, initial_shape, gt_shape=gt_s)
